...
Source/costmap/costmap_2d/%.o: ../Source/costmap/costmap_2d/%.cpp
	...
	g++ -I/usr/include/eigen3 -I"/home/cybernik/Development/Projects/SeNaviCommon/Source" -O0 -g3 -Wall -D BOOST_LOG_DYN_LINK -D logLevel=0 -c -fmessage-length=0 -std=gnu++11 -DBOOST_LOG_DYN_LINK -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
