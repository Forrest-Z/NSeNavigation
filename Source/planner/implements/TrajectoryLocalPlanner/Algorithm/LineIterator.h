#ifndef _BASE_LOCAL_PLANNER_LINE_ITERATOR_H_
#define _BASE_LOCAL_PLANNER_LINE_ITERATOR_H_
...
namespace NS_Planner
{
  ...
  public:
    LineIterator(int x0, int y0, int x1, int y1)
        : x0_(x0), y0_(y0), x1_(x1), y1_(y1), x_(x0) // X and Y start of at first endpoint.
            ,
