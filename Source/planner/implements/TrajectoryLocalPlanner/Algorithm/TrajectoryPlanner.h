...
namespace NS_Planner
{
  ...
  public:
    ...
    TrajectoryPlanner(WorldModel& world_model,
                      ...
                      double circums_radius = 0.36,
                      double inscribe_radius = 0.26);
    ...
    void setFootprint(std::vector< Point2D > footprint)
    {
      footprint_spec_ = footprint;
    }

    std::vector< Point2D > getFootprint() const
    {
  ...
  private:
    ...
    std::vector< Point2D > footprint_spec_; ///< @brief The footprint specification of the robot
