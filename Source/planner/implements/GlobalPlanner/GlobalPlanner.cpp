...
//	NS_NaviCommon::console.debug("After locking...");
    ...
    cout << "start_x_i, start_y_i, start_x, start_y" << start_x_i << " " << start_y_i << " " << start_x << " " << start_y << "\n";
    ...
    cout << "goal_x_i, goal_y_i, goal_x, goal_y" << goal_x_i << " " << goal_y_i << " " << goal_x << " " << goal_y << "\n";
...
//	NS_NaviCommon::console.debug("After clearRobotCell...");
    ...
    double circumscribed_radius = costmap->getLayeredCostmap()->getCircumscribedRadius();
//	NS_NaviCommon::console.debug("After getting nx, ny...");
    cout << "nx, ny = " << nx << " " << ny << " resolution = " << resolution << "inscribed_radius = " << inscribe_radius << "circumscribed_radius = " << circumscribed_radius << "\n";
    cout << "origin x y" << costmap->getLayeredCostmap()->getCostmap()->getOriginX() << " " << costmap->getLayeredCostmap()->getCostmap()->getOriginY() << endl;
...
//	NS_NaviCommon::console.debug("After parameters setSize...");
    unsigned char* char_map = costmap->getLayeredCostmap()->getCostmap()->getCharMap();
